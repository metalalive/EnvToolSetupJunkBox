...
# Instructions for building gcc 10.x from source.

# This gcc build script is free software; you can redistribute it and/or modify
# it under the terms of the MIT license.


# For more detail please check out this article
...
install_dir=${PWD}/${gcc_version}/installed
build_dir=${PWD}/${gcc_version}/build
source_dir=${PWD}/${gcc_version}/src
tarfile_dir=${PWD}/${gcc_version}/tarballs
...
# Note it takes 2 to 3 hours depending on computing power of your machine
cd "$build_dir"
